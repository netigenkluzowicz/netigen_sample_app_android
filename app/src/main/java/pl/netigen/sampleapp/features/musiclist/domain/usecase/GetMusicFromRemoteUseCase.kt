...
class GetMusicFromRemoteUseCase @Inject constructor(private val musicListRepository: MusicListRepository) :
    UseCase<Flow<Resource<List<Music>>>, Unit>() {
    override suspend fun action(params: Unit) = musicListRepository.getMusicFromRemote()
}
