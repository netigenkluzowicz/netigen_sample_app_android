...
class GetAllMusicFromLocalUseCase @Inject constructor(private val musicListRepository: MusicListRepository) : UseCase<Flow<List<Music>>, Unit>() {

    override suspend fun action(params: Unit) = musicListRepository.getMusicFromLocal()
}
